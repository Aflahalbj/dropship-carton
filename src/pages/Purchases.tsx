...
const Purchases: React.FC = () => {
  ...
  const handleAddProduct = (product: Product) => {
    ...
    if (existingProductIndex > -1) {
      ...
      setSelectedProducts([
        ...selectedProducts,
        { product: product, quantity: 1, price: product.supplierPrice },
      ]);
    }
  ...
  const ProductCard = ({ product }: { product: Product }) => {
    ...
    return (
      <Card className="overflow-hidden card-hover h-full flex flex-col cursor-pointer" onClick={() => handleAddProduct(product)}>
  ...
  return (
    <div className="container animate-slide-up py-[10px] px-[2px]">
      <div className="flex justify-between items-center mb-6">
        {showCheckout && (
          <Button variant="ghost" size="icon" onClick={() => setShowCheckout(false)} className="mr-4">
      ...
      {!showCheckout ? (
        <>
          <div className="mb-6 flex flex-wrap gap-4">
            ...
            {selectedSupplier && (
              <div className="flex items-center gap-1 bg-primary/10 rounded-md px-3 py-1 text-sm">
          ...
          <div className="md:col-span-3">
            <div className="border rounded-lg overflow-hidden">
              <div className="bg-accent p-3 border-b flex justify-between items-center">
                ...
                {selectedSupplier && (
                  <span className="text-sm">Supplier: {selectedSupplier.name}</span>
                )}
              </div>
